<?php
    ...
    Route::middleware('auth:sanctum')->get('/job-offers/current-user-job-offers', [JobOfferController::class, 'getCurrentUserJobs']);
    Route::middleware('auth:sanctum')->get('/job-offers/{id}', [JobOfferController::class, 'getOneJobOffer']);
